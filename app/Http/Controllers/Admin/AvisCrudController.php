...
class AvisCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Avis::class);
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::removeColumn('texte');
        CRUD::addColumn([
          // 1-n relationship catégorie / montre la catégorie d'une patisseries
         'label' => "Avi", // Table column heading
         'name' => 'texte', // the column that contains the ID of that connected entity;
        ]);
